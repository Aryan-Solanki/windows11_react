...
const contextItem=[{title:"View",icon:FiGrid,arrow:true}]
  ...
  return (
    <>
      <div onClick={LeftClicked} onContextMenu={customContent} style={{border:(whichIconLeftClick===props.filename&&isIconLeftClicked)?"dotted white 1px":"None" ,marginBottom:"25px",paddingBottom:"6px",width:"80px",display:"flex",alignItems:"center",zIndex:0,flexDirection:"column",background:(isHover||(whichIconClick===props.filename&&isIconClick))?"rgba(255, 255, 255,0.2)":"none",}} onMouseEnter={mouseEnter} onMouseLeave={mouseExit}>
